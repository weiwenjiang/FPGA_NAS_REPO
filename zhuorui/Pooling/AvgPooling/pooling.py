...
class SimpleCNN(torch.nn.Module):
    ...
    def __init__(self):
        ...
        self.pool1 = torch.nn.AvgPool2d(kernel_size=K, stride=K, padding=0)


    def forward(self, x):
        x = torch.round(self.pool1(x)) #æ‹¬å·é‡Œçš„xç›¸å½“äºŽIFMï¼Œ=å³è¾¹çš„ç›¸å½“äºŽOFM
        return(x)
...
print('''FPGA_DATA_FIX output[M*(R/K_avgpool)*(C/K_avgpool)] = {''',end="")
