...
//variance for batch norm
	...
	/**/
	extern FPGA_DATA_FIX output[CH19*(R)*(C)];
	...
	extern FPGA_DATA_FIX bn_y_30[576];
...
*/
	...
	//24, s=2, n=2
	do_conv_pad(6*CH3,CH3,R,C,R+2,C+2,1,1,z_3,weight_4,y_4,bias_4,input_dma_W,input_dma_I,input_dma_B,output_dma_O);
	do_bn(6*CH3,6*CH3,R+2,C+2,y_4,E4,V4,z_4,input_bn_I,running_mean,running_var,output_dma_O);
	do_dconv(6*CH3,6*CH3,R+2,C+2,z_4,weight_5,y_5,bias_5,input_dma_W,input_dma_I,input_dma_B,output_dma_O);
	do_bn(6*CH3,6*CH3,R,C,y_5,E5,V5,z_5,input_bn_I,running_mean,running_var,output_dma_O);
	do_conv(CH4,6*CH3,R,C,1,z_5,weight_6,y_6,bias_6,input_dma_W,input_dma_I,input_dma_B,output_dma_O);
	do_bn(CH4,CH4,R,C,y_6,E6,V6,z_6,input_bn_I,running_mean,running_var,output_dma_O);
    //
	do_conv_pad(6*CH4,CH4,R,C,R+2,C+2,1,1,z_6,weight_7,y_7,bias_7,input_dma_W,input_dma_I,input_dma_B,output_dma_O);
	do_bn(6*CH4,6*CH4,R+2,C+2,y_7,E7,V7,z_7,input_bn_I,running_mean,running_var,output_dma_O);

	do_dconv(6*CH4,6*CH4,R+2,C+2,z_7,weight_8,y_8,bias_8,input_dma_W,input_dma_I,input_dma_B,output_dma_O);
	do_bn(6*CH4,6*CH4,R,C,y_8,E8,V8,z_8,input_bn_I,running_mean,running_var,output_dma_O);

	do_conv(CH5,6*CH4,R,C,1,z_8,weight_9,y_9,bias_9,input_dma_W,input_dma_I,input_dma_B,output_dma_O);
	do_bn(CH5,CH5,R,C,y_9,E9,V9,z_9,input_bn_I,running_mean,running_var,output_dma_O);
	//32, s=2, n=3
	do_conv_pad(6*CH5,CH5,R,C,R+2,C+2,1,1,z_9,weight_10,y_10,bias_10,input_dma_W,input_dma_I,input_dma_B,output_dma_O);
	do_bn(6*CH5,6*CH5,R+2,C+2,y_10,E10,V10,z_10,input_bn_I,running_mean,running_var,output_dma_O);
	do_dconv(6*CH5,6*CH5,R+2,C+2,z_10,weight_11,y_11,bias_11,input_dma_W,input_dma_I,input_dma_B,output_dma_O);
	do_bn(6*CH5,6*CH5,R,C,y_11,E11,V11,z_11,input_bn_I,running_mean,running_var,output_dma_O);
	do_conv(CH6,6*CH5,R,C,1,z_11,weight_12,y_12,bias_12,input_dma_W,input_dma_I,input_dma_B,output_dma_O);
	do_bn(CH6,CH6,R,C,y_12,E12,V12,z_12,input_bn_I,running_mean,running_var,output_dma_O);
    //
	do_conv_pad(6*CH6,CH6,R,C,R+2,C+2,1,1,z_12,weight_13,y_13,bias_13,input_dma_W,input_dma_I,input_dma_B,output_dma_O);
	do_bn(6*CH6,6*CH6,R+2,C+2,y_13,E13,V13,z_13,input_bn_I,running_mean,running_var,output_dma_O);
	do_dconv(6*CH6,6*CH6,R+2,C+2,z_13,weight_14,y_14,bias_14,input_dma_W,input_dma_I,input_dma_B,output_dma_O);
	do_bn(6*CH6,6*CH6,R,C,y_14,E14,V14,z_14,input_bn_I,running_mean,running_var,output_dma_O);
	do_conv(CH7,6*CH6,R,C,1,z_14,weight_15,y_15,bias_15,input_dma_W,input_dma_I,input_dma_B,output_dma_O);
	do_bn(CH7,CH7,R,C,y_15,E15,V15,z_15,input_bn_I,running_mean,running_var,output_dma_O);
	//
	do_conv_pad(6*CH7,CH7,R,C,R+2,C+2,1,1,z_15,weight_16,y_16,bias_16,input_dma_W,input_dma_I,input_dma_B,output_dma_O);
	do_bn(6*CH7,6*CH7,R+2,C+2,y_16,E16,V16,z_16,input_bn_I,running_mean,running_var,output_dma_O);
	do_dconv(6*CH7,6*CH7,R+2,C+2,z_16,weight_17,y_17,bias_17,input_dma_W,input_dma_I,input_dma_B,output_dma_O);
	do_bn(6*CH7,6*CH7,R,C,y_17,E17,V17,z_17,input_bn_I,running_mean,running_var,output_dma_O);
	do_conv(CH8,6*CH7,R,C,1,z_17,weight_18,y_18,bias_18,input_dma_W,input_dma_I,input_dma_B,output_dma_O);
	do_bn(CH8,CH8,R,C,y_18,E18,V18,z_18,input_bn_I,running_mean,running_var,output_dma_O);
	//64, s=2, n=4
	do_conv_pad(6*CH8,CH8,R,C,R+2,C+2,1,1,z_18,weight_19,y_19,bias_19,input_dma_W,input_dma_I,input_dma_B,output_dma_O);
	do_bn(6*CH8,6*CH8,R+2,C+2,y_19,E19,V19,z_19,input_bn_I,running_mean,running_var,output_dma_O);
	do_dconv(6*CH8,6*CH8,R+2,C+2,z_19,weight_20,y_20,bias_20,input_dma_W,input_dma_I,input_dma_B,output_dma_O);
	do_bn(6*CH8,6*CH8,R,C,y_20,E20,V20,z_20,input_bn_I,running_mean,running_var,output_dma_O);
	do_conv(CH9,6*CH8,R,C,1,z_20,weight_21,y_21,bias_21,input_dma_W,input_dma_I,input_dma_B,output_dma_O);
	do_bn(CH9,CH9,R,C,y_21,E21,V21,z_21,input_bn_I,running_mean,running_var,output_dma_O);

	do_conv_pad(6*CH9,CH9,R,C,R+2,C+2,1,1,z_21,weight_22,y_22,bias_22,input_dma_W,input_dma_I,input_dma_B,output_dma_O);
	do_bn(6*CH9,6*CH9,R+2,C+2,y_22,E22,V22,z_22,input_bn_I,running_mean,running_var,output_dma_O);
	do_dconv(6*CH9,6*CH9,R+2,C+2,z_22,weight_23,y_23,bias_23,input_dma_W,input_dma_I,input_dma_B,output_dma_O);
	do_bn(6*CH9,6*CH9,R,C,y_23,E23,V23,z_23,input_bn_I,running_mean,running_var,output_dma_O);
	do_conv(CH10,6*CH9,R,C,1,z_23,weight_24,y_24,bias_24,input_dma_W,input_dma_I,input_dma_B,output_dma_O);
	do_bn(CH10,CH10,R,C,y_24,E24,V24,z_24,input_bn_I,running_mean,running_var,output_dma_O);

	do_conv_pad(6*CH10,CH10,R,C,R+2,C+2,1,1,z_24,weight_25,y_25,bias_25,input_dma_W,input_dma_I,input_dma_B,output_dma_O);
	do_bn(6*CH10,6*CH10,R+2,C+2,y_25,E25,V25,z_25,input_bn_I,running_mean,running_var,output_dma_O);
	do_dconv(6*CH10,6*CH10,R+2,C+2,z_25,weight_26,y_26,bias_26,input_dma_W,input_dma_I,input_dma_B,output_dma_O);
	do_bn(6*CH10,6*CH10,R,C,y_26,E26,V26,z_26,input_bn_I,running_mean,running_var,output_dma_O);
	do_conv(CH11,6*CH10,R,C,1,z_26,weight_27,y_27,bias_27,input_dma_W,input_dma_I,input_dma_B,output_dma_O);
	do_bn(CH11,CH11,R,C,y_27,E27,V27,z_27,input_bn_I,running_mean,running_var,output_dma_O);

	do_conv_pad(6*CH11,CH11,R,C,R+2,C+2,1,1,z_27,weight_28,y_28,bias_28,input_dma_W,input_dma_I,input_dma_B,output_dma_O);
	do_bn(6*CH11,6*CH11,R+2,C+2,y_28,E28,V28,z_28,input_bn_I,running_mean,running_var,output_dma_O);
	do_dconv(6*CH11,6*CH11,R+2,C+2,z_28,weight_29,y_29,bias_29,input_dma_W,input_dma_I,input_dma_B,output_dma_O);
	do_bn(6*CH11,6*CH11,R,C,y_29,E29,V29,z_29,input_bn_I,running_mean,running_var,output_dma_O);
	do_conv(CH12,6*CH11,R,C,1,z_29,weight_30,y_30,bias_30,input_dma_W,input_dma_I,input_dma_B,output_dma_O);
	do_bn(CH12,CH12,R,C,y_30,E30,V30,z_30,input_bn_I,running_mean,running_var,output_dma_O);

	//96, s=1, n=3
	do_conv_pad(6*CH12,CH12,R,C,R+2,C+2,1,1,z_30,weight_31,y_31,bias_31,input_dma_W,input_dma_I,input_dma_B,output_dma_O);
	do_bn(6*CH12,6*CH12,R+2,C+2,y_31,E31,V31,z_31,input_bn_I,running_mean,running_var,output_dma_O);
	do_dconv(6*CH12,6*CH12,R+2,C+2,z_31,weight_32,y_32,bias_32,input_dma_W,input_dma_I,input_dma_B,output_dma_O);
	do_bn(6*CH12,6*CH12,R,C,y_32,E32,V32,z_32,input_bn_I,running_mean,running_var,output_dma_O);
	do_conv(CH13,6*CH12,R,C,1,z_32,weight_33,y_33,bias_33,input_dma_W,input_dma_I,input_dma_B,output_dma_O);
	do_bn(CH13,CH13,R,C,y_33,E33,V33,z_33,input_bn_I,running_mean,running_var,output_dma_O);

	do_conv_pad(6*CH13,CH13,R,C,R+2,C+2,1,1,z_33,weight_34,y_34,bias_34,input_dma_W,input_dma_I,input_dma_B,output_dma_O);
	do_bn(6*CH13,6*CH13,R+2,C+2,y_34,E34,V34,z_34,input_bn_I,running_mean,running_var,output_dma_O);
	do_dconv(6*CH13,6*CH13,R+2,C+2,z_34,weight_35,y_35,bias_35,input_dma_W,input_dma_I,input_dma_B,output_dma_O);
	do_bn(6*CH13,6*CH13,R,C,y_35,E35,V35,z_35,input_bn_I,running_mean,running_var,output_dma_O);
	do_conv(CH14,6*CH13,R,C,1,z_35,weight_36,y_36,bias_36,input_dma_W,input_dma_I,input_dma_B,output_dma_O);
	do_bn(CH14,CH14,R,C,y_36,E36,V36,z_36,input_bn_I,running_mean,running_var,output_dma_O);

	do_conv_pad(6*CH14,CH14,R,C,R+2,C+2,1,1,z_36,weight_37,y_37,bias_37,input_dma_W,input_dma_I,input_dma_B,output_dma_O);
	do_bn(6*CH14,6*CH14,R+2,C+2,y_37,E37,V37,z_37,input_bn_I,running_mean,running_var,output_dma_O);
	do_dconv(6*CH14,6*CH14,R+2,C+2,z_37,weight_38,y_38,bias_38,input_dma_W,input_dma_I,input_dma_B,output_dma_O);
	do_bn(6*CH14,6*CH14,R,C,y_38,E38,V38,z_38,input_bn_I,running_mean,running_var,output_dma_O);
	do_conv(CH15,6*CH14,R,C,1,z_38,weight_39,y_39,bias_39,input_dma_W,input_dma_I,input_dma_B,output_dma_O);
	do_bn(CH15,CH15,R,C,y_39,E39,V39,z_39,input_bn_I,running_mean,running_var,output_dma_O);
	//160, s=2, n=3
	do_conv_pad(6*CH15,CH15,R,C,R+2,C+2,1,1,z_39,weight_40,y_40,bias_40,input_dma_W,input_dma_I,input_dma_B,output_dma_O);
	do_bn(6*CH15,6*CH15,R+2,C+2,y_40,E40,V40,z_40,input_bn_I,running_mean,running_var,output_dma_O);
	do_dconv(6*CH15,6*CH15,R+2,C+2,z_40,weight_41,y_41,bias_41,input_dma_W,input_dma_I,input_dma_B,output_dma_O);
	do_bn(6*CH15,6*CH15,R,C,y_41,E41,V41,z_41,input_bn_I,running_mean,running_var,output_dma_O);
	do_conv(CH16,6*CH15,R,C,1,z_41,weight_42,y_42,bias_42,input_dma_W,input_dma_I,input_dma_B,output_dma_O);
	do_bn(CH16,CH16,R,C,y_42,E42,V42,z_42,input_bn_I,running_mean,running_var,output_dma_O);

	do_conv_pad(6*CH16,CH16,R,C,R+2,C+2,1,1,z_42,weight_43,y_43,bias_43,input_dma_W,input_dma_I,input_dma_B,output_dma_O);
	do_bn(6*CH16,6*CH16,R+2,C+2,y_43,E43,V43,z_43,input_bn_I,running_mean,running_var,output_dma_O);
	do_dconv(6*CH16,6*CH16,R+2,C+2,z_43,weight_44,y_44,bias_44,input_dma_W,input_dma_I,input_dma_B,output_dma_O);
	do_bn(6*CH16,6*CH16,R,C,y_44,E44,V44,z_44,input_bn_I,running_mean,running_var,output_dma_O);
	do_conv(CH17,6*CH16,R,C,1,z_44,weight_45,y_45,bias_45,input_dma_W,input_dma_I,input_dma_B,output_dma_O);
	do_bn(CH17,CH17,R,C,y_45,E45,V45,z_45,input_bn_I,running_mean,running_var,output_dma_O);

	do_conv_pad(6*CH17,CH17,R,C,R+2,C+2,1,1,z_45,weight_46,y_46,bias_46,input_dma_W,input_dma_I,input_dma_B,output_dma_O);
	do_bn(6*CH17,6*CH17,R+2,C+2,y_46,E46,V46,z_46,input_bn_I,running_mean,running_var,output_dma_O);
	do_dconv(6*CH17,6*CH17,R+2,C+2,z_46,weight_47,y_47,bias_47,input_dma_W,input_dma_I,input_dma_B,output_dma_O);
	do_bn(6*CH17,6*CH17,R,C,y_47,E47,V47,z_47,input_bn_I,running_mean,running_var,output_dma_O);
	do_conv(CH18,6*CH17,R,C,1,z_47,weight_48,y_48,bias_48,input_dma_W,input_dma_I,input_dma_B,output_dma_O);
	do_bn(CH18,CH18,R,C,y_48,E48,V48,z_48,input_bn_I,running_mean,running_var,output_dma_O);
	//320, s=1, n=1
	do_conv_pad(6*CH18,CH18,R,C,R+2,C+2,1,1,z_48,weight_49,y_49,bias_49,input_dma_W,input_dma_I,input_dma_B,output_dma_O);
	do_bn(6*CH18,6*CH18,R+2,C+2,y_49,E49,V49,z_49,input_bn_I,running_mean,running_var,output_dma_O);
	do_dconv(6*CH18,6*CH18,R+2,C+2,z_49,weight_50,y_50,bias_50,input_dma_W,input_dma_I,input_dma_B,output_dma_O);
	do_bn(6*CH18,6*CH18,R,C,y_50,E50,V50,z_50,input_bn_I,running_mean,running_var,output_dma_O);
	do_conv(CH19,6*CH18,R,C,1,z_50,weight_51,y_51,bias_51,input_dma_W,input_dma_I,input_dma_B,output_dma_O);
	do_bn(CH19,CH19,R,C,y_51,E51,V51,z_51,input_bn_I,running_mean,running_var,output_dma_O);
/*
*/
	...
	for(int m=0;m<CH19;m++){
		for(int r=0;r<real_R;r++){
			for(int c=0;c<real_C;c++){
				int res;
				int g_res;
				res = z_51[m*(real_R)*(real_C) + r*(real_C) + c];
