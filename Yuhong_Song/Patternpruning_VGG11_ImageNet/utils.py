...
def prune_pattern_weight(weight,device,str,key):#使用pattern剪枝
    weight_numpy = weight.detach().cpu().numpy()
    vgg_conv_layer = {0:[64,3],3:[128,64],6:[256,128],
                      8:[256,256],11:[512,256],13:[512,512],
                      16:[512,512],18:[512,512]}
    value = vgg_conv_layer[key]
