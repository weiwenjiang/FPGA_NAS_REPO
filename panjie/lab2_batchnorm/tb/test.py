...
class SimpleCNN(torch.nn.Module):
    ...
    def __init__(self):
        ...
        self.bn = torch.nn.BatchNorm2d(CH2,)
...
E = torch.randint(0,3,(CH2,),dtype=torch.float)
V = torch.randint(-1,2,(CH2,),dtype=torch.float)
...
CNN.state_dict()["bn.running_mean"][:] = E
CNN.state_dict()["bn.running_var"][:] = V
...
print('''FPGA_DATA_FIX E[CH2] = {''',end="")
ifm_list = E.flatten().tolist()
print_list(ifm_list)

print('''FPGA_DATA_FIX V[CH2] = {''',end="")
ifm_list = V.flatten().tolist()
print_list(ifm_list)
