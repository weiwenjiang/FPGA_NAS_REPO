...
int main(){
	...
	extern FPGA_DATA_FIX output[N*(R/K_maxpool)*(C/K_maxpool)];
	FPGA_DATA_FIX stage1_pool_output[N*(R/K_maxpool)*(C/K_maxpool)];
	int real_R = R/K_maxpool;
	int real_C = C/K_maxpool;


	do_maxpool(N,N,R,C,R/K_maxpool,C/K_maxpool,input,stage1_pool_output,input_dma_W,input_dma_I,input_dma_B,output_dma_O);
